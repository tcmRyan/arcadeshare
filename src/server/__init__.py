...
import psycopg2
from src.server.admin.views import ArcadeAdminIndexView, UserView
from src.server.utils import create_binds, MultiTenantSQLA
...
def create_app():
    ...
    with app.app_context():
        from src.server import main, auth
        from src.server.auth.models import Role, User, Tenant
        from src.server.auth import MqttAcl
